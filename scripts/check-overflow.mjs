...
const PAGES = [
  '/', '/contacto/', '/about/', '/en/about/',
  '/blog/', '/en/blog/', '/blog/estudio-software-autonomo/', '/blog/flotas-agentes-ia/', '/blog/tests-amanados-agentes/', '/blog/coste-real-agentes-ia/', '/claudescope/', '/inferbench/',
